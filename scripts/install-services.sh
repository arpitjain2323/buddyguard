...
echo "  3. Add BuddyGuardAgent.app (in the project folder) to System Settings → Privacy & Security → Screen Recording."
echo "  4. Load the services:"
...
echo "  5. To stop: launchctl unload ... (same paths with unload)."
